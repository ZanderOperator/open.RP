...
public OnBizzFurnitureObjectsLoad(biznisid)
{
	...
	for( new i = 0; i < objectCount; i++ )
	{
		...
		cache_get_value_name(i, 		"name"			, BiznisFurnitureObjectName[ biznisid ][ i ], 30);
...
stock static CreateBiznisFurnitureObject(playerid, modelid, Float:x, Float:y, Float:z, Float:rx, Float:ry, Float:rz, bool:doors)
{
	...
	format(BiznisFurnitureObjectName[ biznisid ][ index ], 30, GetFurnitureObjectName(playerid, BizzPlayerPrwsIndex[ playerid ]));
	...
	format(insertObject, 1512, "INSERT INTO `biznis_furniture`(`biznisid`, `name`, `modelid`, `door`, `door_z`, `locked_door`, `pos_x`, `pos_y`, `pos_z`, `rot_x`, `rot_y`, `rot_z`, `texture_1`, `texture_2`, `texture_3`, `texture_4`, `color_1`, `color_2`, `color_3`, `color_4`) VALUES ('%d', '%q', '%d', '%d', '%f', '%d', '%f', '%f', '%f', '%f', '%f', '%f', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d')",
		BizzInfo[ biznisid ][ bSQLID ],
		BiznisFurnitureObjectName[ biznisid ][ index ],
	...
	else
	{
		...
		format(BiznisFurnitureObjectName[ biznisid ][ index ], 30, "None");
...
stock static CopyFurnitureObject(playerid, copyid)
{
	...
	format(BiznisFurnitureObjectName[ biznisid ][ index ], 30, BiznisFurnitureObjectName[ biznisid ][ copyid ] );
	...
	new
		insertObject[ 512 ];
	format(insertObject, 512, "INSERT INTO `biznis_furniture` (`biznisid`,`name`,`modelid`,`door`,`door_z`,`locked_door`,`pos_x`,`pos_y`,`pos_z`,`rot_x`,`rot_y`,`rot_z`,`texture_1`,`texture_2`,`texture_3`,`texture_4`,`color_1`,`color_2`,`color_3`,`color_4`) VALUES ('%d','%q','%d','%d','%f','%d','%f','%f','%f','%f','%f','%f','%d','%d','%d','%d','%d','%d','%d','%d')",
		biznisid,
		BiznisFurnitureObjectName[ biznisid ][ index ],
		BizzInfo[ biznisid ][ bFurModelid ][ index ],
		BizzInfo[ biznisid ][ bFurDoor ][ index ],
...
stock static DeleteFurnitureObject(biznisid, index, playerid)
{
	...
	new
		deleteObject[ 64 ];
	format(deleteObject, 64, "DELETE FROM furniture WHERE sqlid = '%d'", BizzInfo[ biznisid ][ bFurSQL ][ index ]);
	...
	va_SendClientMessage(playerid, COLOR_RED, "[ ! ] Uspjesno ste obrisali %s(object id: %d).", FurnitureObjectName[ biznisid ][ index ], BizzInfo[ biznisid ][ bFurObjectid ][ index ]);
	return 1;
}
...
hook OnGameModeInit()
{
	// Interiori
	new tmpobjid;
	tmpobjid = CreateObject(1508, 1474.712158, -566.563720, 1082.593750, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 8391, "ballys01", "vgncorpdoor1_512", 0x00000000);
	...
	tmpobjid = CreateObject(1508, 1401.573120, -600.114807, 1085.758666, 0.000000, 0.000000, 90.000022);
	SetObjectMaterial(tmpobjid, 0, 10763, "airport1_sfse", "ws_airportdoors1", 0x00000000);
	tmpobjid = CreateObject(19379, 1388.371704, -620.458618, 1084.210327, 0.000000, 89.999969, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14832, "lee_stripclub", "Strip_ceiling", 0x00000000);
	tmpobjid = CreateObject(19387, 1393.535888, -618.613769, 1086.049560, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampwhite", 0x00000000);
	tmpobjid = CreateObject(19449, 1393.535034, -625.036071, 1086.049438, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampwhite", 0x00000000);
	tmpobjid = CreateObject(19449, 1388.587768, -624.314697, 1086.049438, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14548, "ab_cargo_int", "ab_planeBoby", 0x00000000);
	tmpobjid = CreateObject(19449, 1387.640991, -621.658630, 1086.049438, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14548, "ab_cargo_int", "ab_planeBoby", 0x00000000);
	tmpobjid = CreateObject(19449, 1388.501953, -616.948120, 1086.049438, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14548, "ab_cargo_int", "ab_planeBoby", 0x00000000);
	tmpobjid = CreateObject(19379, 1388.030273, -620.486816, 1087.258911, 0.000000, 90.000000, 0.059999);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampwhite", 0x00000000);
	tmpobjid = CreateObject(19929, 1388.043457, -621.943176, 1084.334594, 0.000000, 0.000000, 0.000000);
	...
	tmpobjid = CreateObject(19929, 1388.044555, -619.081176, 1084.334594, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 10765, "airportgnd_sfse", "black64", 0x00000000);
	SetObjectMaterial(tmpobjid, 1, 10765, "airportgnd_sfse", "white", 0x00000000);
	tmpobjid = CreateObject(11707, 1390.057373, -617.107727, 1085.604736, 0.000000, 0.000000, 360.000000);
	SetObjectMaterial(tmpobjid, 0, 14548, "ab_cargo_int", "ab_planeBoby", 0x00000000);
	tmpobjid = CreateObject(19437, 1392.463867, -619.879577, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(2024, 1387.205932, -622.279968, 1087.106323, 0.000000, 90.000045, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "policeshieldgls", 0x00000000);
	tmpobjid = CreateObject(19437, 1392.463867, -621.478576, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(19437, 1390.860839, -619.879577, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(19437, 1390.857910, -621.478576, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(19437, 1390.857910, -621.656616, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(19437, 1392.463867, -621.656616, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(19437, 1390.857910, -623.321594, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(19437, 1392.463867, -623.321594, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 4101, "stapl", "sl_laexpowall1", 0x00000000);
	tmpobjid = CreateObject(19437, 1390.857910, -623.497619, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 19597, "lsbeachside", "ceilingtiles4-128x128", 0x00000000);
	tmpobjid = CreateObject(19437, 1392.463867, -623.497619, 1085.154541, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 19597, "lsbeachside", "ceilingtiles4-128x128", 0x00000000);
	tmpobjid = CreateObject(1491, 1390.182006, -621.481201, 1084.366577, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 3899, "hospital2", "airportdoor1", 0x00000000);
	tmpobjid = CreateObject(1491, 1390.182006, -623.217224, 1084.366577, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 3899, "hospital2", "airportdoor1", 0x00000000);
	tmpobjid = CreateObject(2024, 1387.205932, -619.329528, 1087.096191, 0.000000, 90.000045, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "policeshieldgls", 0x00000000);
	tmpobjid = CreateObject(19437, 1471.652099, -608.945922, 1084.408203, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(1491, 1393.563476, -619.361816, 1084.284545, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18646, "matcolours", "grey-95-percent", 0x00000000);
	tmpobjid = CreateObject(19387, 1466.760986, -609.822509, 1084.484375, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14832, "lee_stripclub", "Strip_bar_wall1", 0x00000000);
	tmpobjid = CreateObject(19449, 1470.116821, -609.821777, 1084.164062, 90.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14832, "lee_stripclub", "Strip_bar_wall1", 0x00000000);
	tmpobjid = CreateObject(19449, 1469.965209, -602.809082, 1084.164062, 180.000000, 180.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19449, 1466.904785, -609.815795, 1091.032104, 90.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14832, "lee_stripclub", "Strip_bar_wall1", 0x00000000);
	tmpobjid = CreateObject(19449, 1465.094970, -604.918212, 1084.162109, 180.000000, 180.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19449, 1474.139038, -604.918212, 1084.162109, 180.000000, 180.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1473.253051, -608.945922, 1084.408203, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1470.051269, -608.945922, 1084.408203, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1469.238403, -608.933227, 1084.408203, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19379, 1470.436035, -605.056701, 1082.647949, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14537, "pdomebar", "club_floor2_sfwTEST", 0x00000000);
	tmpobjid = CreateObject(19379, 1470.439941, -605.056701, 1085.782958, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampblack", 0x00000000);
	tmpobjid = CreateObject(1491, 1465.979980, -609.807434, 1082.725952, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampblack", 0x00000000);
	tmpobjid = CreateObject(19449, 1470.116821, -609.645812, 1084.164062, 90.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19387, 1466.762451, -609.645629, 1084.484375, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19449, 1393.525268, -620.214904, 1089.549438, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampwhite", 0x00000000);
	tmpobjid = CreateObject(19929, 1470.754150, -608.567626, 1082.736083, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampblack", 0x00000000);
	SetObjectMaterial(tmpobjid, 1, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19929, 1473.615112, -608.567626, 1082.736083, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampblack", 0x00000000);
	SetObjectMaterial(tmpobjid, 1, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1465.234863, -603.695007, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "policeshieldgls", 0x00000000);
	tmpobjid = CreateObject(19437, 1465.235839, -605.300598, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1471.005126, -608.936523, 1085.302246, 0.000000, 90.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampblack", 0x00000000);
	tmpobjid = CreateObject(19437, 1474.505126, -608.936523, 1085.302246, 0.000000, 90.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "sampblack", 0x00000000);
	tmpobjid = CreateObject(19437, 1471.042968, -608.197204, 1086.018188, 89.000000, 270.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1474.535034, -608.197204, 1086.018188, 89.000000, 270.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1466.829956, -603.695007, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1466.829956, -605.297973, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(1491, 1465.315551, -605.981079, 1083.045654, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(1491, 1466.848632, -606.038085, 1083.045654, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1468.413940, -605.297973, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1468.413940, -603.692016, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(1491, 1468.472656, -606.038085, 1083.045654, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1469.901977, -605.299377, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1469.901855, -603.693969, 1084.487060, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 18835, "mickytextures", "whiteforletters", 0x00000000);
	tmpobjid = CreateObject(19437, 1387.943481, -618.586425, 1087.057617, 0.000000, 90.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 10765, "airportgnd_sfse", "white", 0x00000000);
	tmpobjid = CreateObject(19437, 1387.943481, -622.085388, 1087.057617, 0.000000, 90.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 10765, "airportgnd_sfse", "white", 0x00000000);
	tmpobjid = CreateObject(19437, 1387.943481, -625.585388, 1087.057617, 0.000000, 90.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 10765, "airportgnd_sfse", "white", 0x00000000);
	tmpobjid = CreateObject(2024, 1471.179321, -609.366271, 1085.165649, -90.300018, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 18996, "mattextures", "policeshieldgls", 0x00000000);
	tmpobjid = CreateObject(19449, 1534.131347, -619.890380, 1082.479003, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19449, 1534.131347, -619.890380, 1085.977050, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19449, 1537.760498, -618.285522, 1082.479003, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19449, 1537.760498, -618.285522, 1085.977050, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19449, 1530.623535, -618.285522, 1082.479003, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19449, 1530.623535, -618.285522, 1085.978027, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19379, 1535.913818, -618.291198, 1080.713012, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_ceiling1", 0x00000000);
	tmpobjid = CreateObject(19379, 1535.913818, -618.291198, 1084.772949, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_concFloor", 0x00000000);
	tmpobjid = CreateObject(19387, 1532.278442, -613.383789, 1082.253051, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 10370, "alleys_sfs", "ws_sandstone1", 0x00000000);
	tmpobjid = CreateObject(19449, 1538.699218, -613.382019, 1082.250976, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 10370, "alleys_sfs", "ws_sandstone1", 0x00000000);
	tmpobjid = CreateObject(19449, 1535.214233, -613.383972, 1085.748046, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 10370, "alleys_sfs", "ws_sandstone1", 0x00000000);
	tmpobjid = CreateObject(1491, 1531.495849, -613.414184, 1080.486694, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 2589, "ab_ab", "ab_sheetSteel", 0x00000000);
	tmpobjid = CreateObject(19449, 1538.699218, -613.564025, 1082.250976, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19387, 1532.277221, -613.565124, 1082.253051, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19449, 1535.214233, -613.562988, 1085.748046, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19387, 1576.974121, -606.726196, 1085.522460, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 1259, "billbrd", "fence1", 0x00000000);
	tmpobjid = CreateObject(19449, 1570.551025, -606.726196, 1085.516357, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 1259, "billbrd", "fence1", 0x00000000);
	tmpobjid = CreateObject(19449, 1571.096679, -601.838195, 1085.516357, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 6404, "beafron1_law2", "compfence7_LAe", 0x00000000);
	tmpobjid = CreateObject(19449, 1578.546752, -601.838195, 1085.516357, 0.000000, 0.000000, 180.000000);
	SetObjectMaterial(tmpobjid, 0, 6404, "beafron1_law2", "compfence7_LAe", 0x00000000);
	tmpobjid = CreateObject(19449, 1575.475585, -602.346374, 1085.516357, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 6404, "beafron1_law2", "compfence7_LAe", 0x00000000);
	tmpobjid = CreateObject(19379, 1573.505493, -601.815490, 1084.203857, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 3080, "adjumpx", "planks64", 0x00000000);
	tmpobjid = CreateObject(19379, 1573.505493, -601.815490, 1087.272949, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_concFloor", 0x00000000);
	tmpobjid = CreateObject(19449, 1620.446289, -614.372924, 1083.850341, 0.000000, 0.000000, 270.000000);
	SetObjectMaterial(tmpobjid, 0, 14794, "ab_vegasgymmain", "bbar_wall3", 0x00000000);
	tmpobjid = CreateObject(19387, 1617.304565, -608.790222, 1083.850952, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14652, "ab_trukstpa", "bbar_wall4", 0x00000000);
	tmpobjid = CreateObject(19449, 1623.726562, -608.789672, 1083.850341, 0.000000, 0.000000, 270.000000);
	SetObjectMaterial(tmpobjid, 0, 14652, "ab_trukstpa", "bbar_wall4", 0x00000000);
	tmpobjid = CreateObject(19449, 1620.277343, -613.695678, 1083.850341, 0.000000, 0.000000, 360.000000);
	SetObjectMaterial(tmpobjid, 0, 14794, "ab_vegasgymmain", "bbar_wall3", 0x00000000);
	tmpobjid = CreateObject(19449, 1620.548339, -608.789794, 1087.347290, 0.000000, 0.000000, 270.000000);
	SetObjectMaterial(tmpobjid, 0, 14652, "ab_trukstpa", "bbar_wall4", 0x00000000);
	tmpobjid = CreateObject(19449, 1615.877075, -613.675781, 1083.850341, 0.000000, 0.000000, 360.000000);
	SetObjectMaterial(tmpobjid, 0, 14794, "ab_vegasgymmain", "bbar_wall3", 0x00000000);
	tmpobjid = CreateObject(19449, 1623.726562, -608.931701, 1083.850341, 0.000000, 0.000000, 270.000000);
	SetObjectMaterial(tmpobjid, 0, 14794, "ab_vegasgymmain", "bbar_wall3", 0x00000000);
	tmpobjid = CreateObject(19387, 1617.304565, -608.932189, 1083.850952, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14794, "ab_vegasgymmain", "bbar_wall3", 0x00000000);
	tmpobjid = CreateObject(19379, 1619.635864, -613.846374, 1082.035522, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14786, "ab_sfgymbeams", "gym_floor5", 0x00000000);
	tmpobjid = CreateObject(19379, 1619.635864, -613.846374, 1085.301513, 0.000000, 90.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 14652, "ab_trukstpa", "bbar_wall1", 0x00000000);
	tmpobjid = CreateObject(1491, 1576.191284, -606.610473, 1084.181640, 0.000000, 0.000000, 0.000000);
	SetObjectMaterial(tmpobjid, 0, 2589, "ab_ab", "ab_sheetSteel", 0x00000000);
	tmpobjid = CreateObject(19387, 1576.974121, -606.568176, 1085.522460, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 6404, "beafron1_law2", "compfence7_LAe", 0x00000000);
	tmpobjid = CreateObject(19449, 1571.197631, -606.569702, 1085.516357, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 6404, "beafron1_law2", "compfence7_LAe", 0x00000000);
	tmpobjid = CreateObject(19437, 1536.862670, -619.713623, 1082.548706, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19437, 1535.258666, -619.713623, 1082.548706, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19437, 1536.862670, -618.255615, 1082.548706, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19437, 1535.258666, -618.255615, 1082.548706, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(1491, 1534.518920, -618.184082, 1081.275512, 0.000000, 0.000000, -90.000000);
	SetObjectMaterial(tmpobjid, 0, 2589, "ab_ab", "ab_sheetSteel", 0x00000000);
	tmpobjid = CreateObject(1491, 1534.518920, -616.650085, 1081.275512, 0.000000, 0.000000, -90.000000);
	SetObjectMaterial(tmpobjid, 0, 2589, "ab_ab", "ab_sheetSteel", 0x00000000);
	tmpobjid = CreateObject(19437, 1535.258666, -616.544616, 1082.548706, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
	tmpobjid = CreateObject(19437, 1536.862670, -616.544616, 1082.548706, 0.000000, 0.000000, 90.000000);
	SetObjectMaterial(tmpobjid, 0, 14584, "ab_abbatoir01", "ab_tiles", 0x00000000);
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	switch( dialogid ) {
		...
		case DIALOG_BIZZ_FURN_EDIT_LIST:
		{
			...
			switch( listitem )
			{
				case 0: ShowPlayerDialog(playerid, DIALOG_BIZZ_FURN_NAME, DIALOG_STYLE_INPUT, "Uredjivanje naziva slota", "Unesite naziv slota"COL_RED"(1-29 znakova)", "Unesi", "Odustani");
				case 1: EditFurnitureObject(playerid, BizzPlayerEditIndex[ playerid ]); // UI Edit
				case 2: {	// Texture
					LastBizzTextureListIndex[ playerid ] = 1;
					new
						buffer[ 10256 ],
					...
					format(buffer, 10256, "%sPotrazi teksturu\nDalje", buffer );
					ShowPlayerDialog(playerid, DIALOG_BIZZ_FURN_TXTS, DIALOG_STYLE_TABLIST_HEADERS, "Furniture - Teksture", buffer, "Odaberi", "Odustani");
				}
				case 3: {	// Boje
					new
						buffer[ 2625 ];
		...
		case DIALOG_BIZZ_FURN_NAME: {
			if( !response ) return ShowPlayerDialog(playerid, DIALOG_BIZZ_FURN_EDIT_LIST, DIALOG_STYLE_LIST, "Furniture - Uredjivanje", "Uredi naziv\nUredjivanje (UI)\nTeksture\nBoje\nKopiraj objekt\nObrisi objekt\nObrisi teksture i boje", "Odaberi", "Odustani");
			if( 1 <= strlen(inputtext) <= 29 ) {
				new
					biznisid = GetPlayerFurnitureBiznis(playerid),
					slot = BizzPlayerEditIndex[ playerid ],
					updateQuery[ 256 ];

				format(BiznisFurnitureObjectName[ biznisid ][ slot ], 30, inputtext);
				SendClientMessage(playerid, COLOR_GREEN, "[INFO]: Uspjesno ste promjenili naziv slota!");

				format(updateQuery, 256, "UPDATE furniture SET name = '%q' WHERE sqlid = '%d'",
					BiznisFurnitureObjectName[ biznisid ][ slot ],
					BizzInfo[ biznisid ][ bFurSQL ][ slot ]
				);
				mysql_tquery(g_SQL, updateQuery, "");

			} else ShowPlayerDialog(playerid, DIALOG_BIZZ_FURN_NAME, DIALOG_STYLE_INPUT, "Uredjivanje naziva slota", "Unesite naziv slota"COL_RED"(1-29 znakova)", "Unesi", "Odustani");
			return 1;
		}
		...
		case DIALOG_BIZZ_FURN_TXTS_SRCH_2: {
			if( !response ) return va_ShowPlayerDialog(playerid, DIALOG_BIZZ_FURN_EDIT_LIST, DIALOG_STYLE_LIST, "Furniture - Uredjivanje", "Uredi naziv\nUredjivanje (UI)\nTeksture\nBoje\nKopiraj objekt\nObrisi objekt\nObrisi teksture i boje", "Odaberi", "Odustani");
...
hook OnModelSelResponse( playerid, extraid, index, modelid, response )
{
	switch(extraid)
	{
		case DIALOG_BIZZ_FURN_EDIT:
		{
			...
			va_ShowPlayerDialog(playerid, DIALOG_BIZZ_FURN_EDIT_LIST, DIALOG_STYLE_LIST, "Furniture - Uredjivanje", "Uredi naziv\nUredjivanje (UI)\nTeksture\nBoje\nKopiraj objekt\nObrisi objekt\nObrisi teksture i boje", "Odaberi", "Odustani");
			ResetFurnitureShuntVar(playerid);
		}
