...
static stock
    ...
    PlayerText:MDCPlayerheader[MAX_PLAYERS]	= { PlayerText:INVALID_TEXT_DRAW, ... },
	...
	PlayerText:MDCPlayerrank[MAX_PLAYERS]		= { PlayerText:INVALID_TEXT_DRAW, ... },
	PlayerText:MDCPlayerIme[MAX_PLAYERS]		= { PlayerText:INVALID_TEXT_DRAW, ... },
...
stock static OnPlayerPlayerDataLoad(playerid, const playername[])
{
	new mysqlQuery[128];
	...
	inline OnPlayerMDCLoad()
	{
		...
		CreatePlayerProfile(playerid, loadInfo[ pSkin ], false);
...
stock static UpdatePlayerTextDraws(playerid)
{
	DestroyUpdatedPlayerTextDraws(playerid);
...
stock static DestroyUpdatedPlayerTextDraws(playerid)
{
...
stock DestroyMDC(playerid)
{
	...
	PlayerTextDrawDestroy(playerid, MDCPlayerheader[ playerid ] );
	MDCPlayerheader[ playerid ] = PlayerText:INVALID_TEXT_DRAW;
 	PlayerTextDrawDestroy(playerid, MDCKSkin[ playerid ] );
	MDCKSkin[ playerid ] = PlayerText:INVALID_TEXT_DRAW;
	PlayerTextDrawDestroy(playerid, MDCPlayerrank[ playerid ] );
	MDCPlayerrank[ playerid ] = PlayerText:INVALID_TEXT_DRAW;
	PlayerTextDrawDestroy(playerid, MDCPlayerIme[ playerid ] );
	MDCPlayerIme[ playerid ] = PlayerText:INVALID_TEXT_DRAW;
...
stock static CreatePlayer(playerid)
{
    DestroyMDC(playerid);
	...
	MDCPlayerheader[playerid]  = CreatePlayerTextDraw(playerid, 177.000000, 137.062500, "Los_Santos_Police_Department~n~");
	PlayerTextDrawLetterSize(playerid, MDCPlayerheader[playerid], 0.185999, 1.110000);
	PlayerTextDrawTextSize(playerid, MDCPlayerheader[playerid], 515.000000, 0.000000);
	PlayerTextDrawAlignment(playerid, MDCPlayerheader[playerid], 1);
	PlayerTextDrawColor(playerid, MDCPlayerheader[playerid], -1);
	PlayerTextDrawUseBox(playerid, MDCPlayerheader[playerid], 1);
	PlayerTextDrawBoxColor(playerid, MDCPlayerheader[playerid], 255);
	PlayerTextDrawSetShadow(playerid, MDCPlayerheader[playerid], 0);
	PlayerTextDrawSetOutline(playerid, MDCPlayerheader[playerid], 0);
	PlayerTextDrawBackgroundColor(playerid, MDCPlayerheader[playerid], 255);
	PlayerTextDrawFont(playerid, MDCPlayerheader[playerid], 2);
	PlayerTextDrawSetProportional(playerid, MDCPlayerheader[playerid], 1);
	PlayerTextDrawSetShadow(playerid, MDCPlayerheader[playerid], 0);
	PlayerTextDrawShow(playerid, MDCPlayerheader[playerid]);
	...
	MDCPlayerrank[ playerid ] = CreatePlayerTextDraw(playerid, 372.500000, 220.625000, "_");
	PlayerTextDrawLetterSize(playerid, MDCPlayerrank[ playerid ], 0.500000, 2.164374);
	PlayerTextDrawAlignment(playerid, MDCPlayerrank[ playerid ], 2);
	PlayerTextDrawColor(playerid, MDCPlayerrank[ playerid ], 255);
	PlayerTextDrawSetShadow(playerid, MDCPlayerrank[ playerid ], 0);
	PlayerTextDrawSetOutline(playerid, MDCPlayerrank[ playerid ], 0);
	PlayerTextDrawBackgroundColor(playerid, MDCPlayerrank[ playerid ], 255);
	PlayerTextDrawFont(playerid, MDCPlayerrank[ playerid ], 2);
	PlayerTextDrawSetProportional(playerid, MDCPlayerrank[ playerid ], 1);
	PlayerTextDrawSetShadow(playerid, MDCPlayerrank[ playerid ], 0);
	PlayerTextDrawShow(playerid, MDCPlayerrank[ playerid ]);

	MDCPlayerIme[ playerid ] = CreatePlayerTextDraw(playerid, 372.500000, 239.437500, "_");
	PlayerTextDrawLetterSize(playerid, MDCPlayerIme[ playerid ], 0.387499, 1.770625);
	PlayerTextDrawAlignment(playerid, MDCPlayerIme[ playerid ], 2);
	PlayerTextDrawColor(playerid, MDCPlayerIme[ playerid ], 255);
	PlayerTextDrawSetShadow(playerid, MDCPlayerIme[ playerid ], 0);
	PlayerTextDrawSetOutline(playerid, MDCPlayerIme[ playerid ], 0);
	PlayerTextDrawBackgroundColor(playerid, MDCPlayerIme[ playerid ], 255);
	PlayerTextDrawFont(playerid, MDCPlayerIme[ playerid ], 2);
	PlayerTextDrawSetProportional(playerid, MDCPlayerIme[ playerid ], 1);
	PlayerTextDrawSetShadow(playerid, MDCPlayerIme[ playerid ], 0);
	PlayerTextDrawShow(playerid, MDCPlayerIme[playerid]);
...
stock static CreatePlayerProfile(playerid, skin, bool:type=false)
{
    DestroyMDC(playerid);
...
stock static CreatePlayerCCTV(playerid)
{
    DestroyMDC(playerid);
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	switch(dialogid)
	{
		...
		case DIALOG_MDC_PLAYER: {
			...
			OnPlayerPlayerDataLoad(playerid, TargetName[playerid]);
			DestroyMDC(playerid);
			return 1;
		}
...
CMD:mdc(playerid, params[])
{
	...
	PlayerTextDrawSetString(playerid, MDCPlayerrank[playerid], ReturnPlayerRankName(playerid));
	new name[MAX_PLAYER_NAME];
    GetPlayerName(playerid, name, MAX_PLAYER_NAME);
    PlayerTextDrawSetString(playerid, MDCPlayerIme[playerid], name);
