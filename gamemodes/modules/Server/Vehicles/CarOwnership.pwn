...
hook OnGameModeInit()
{
	AddPublicToFunctionSet("RemoveTrunkObjects", vehicleid);
	AddPublicToFunctionSet("RespawnTrunkObjects", vehicleid);
	AddPublicToFunctionSet("CheckPlayerVehicle", playerid);
	AddPublicToFunctionSet("GetPlayerVehicleList", playerid);
	AddPublicToFunctionSet("ResetVehicleAlarm", vehicleid);
	AddPublicToFunctionSet("CheckVehicleInsurance", vehicleid);
	AddPublicToFunctionSet("StartHotwiring", playerid, vehicleid);
	return 1;
}
