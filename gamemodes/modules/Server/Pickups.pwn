...
stock static CreateNewPickup(playerid, pickup)
{
	...
	format(bigquery, sizeof(bigquery), "INSERT INTO server_pickups (`pickupmodel`,`pickuptype`,`canenter`,`entrancex`, `entrancey`, `entrancez`,`exitx`,`exity`,`exitz`,`enterdiscription`, `discription`, `viwo`, `organizations`, `job`, `pint`) VALUES ('%d', '%d', '%d', '%f', '%f', '%f', '%f', '%f', '%f', '%s', '%s', '%d', '%d', '%d', '%d')",
