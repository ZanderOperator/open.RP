...
stock LogWorkerPay(string[])
{
	...
	new File:hFile;
	hFile = fopen("/logfiles/biznis_workerpay.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}

stock LogPickItem(string[])
{
	new
	    entry[256],
		month,
	...
	format(entry, sizeof(entry), "\n[%02d/%02d/%d] %s", day, month, year, string);
	new File:hFile;
	hFile = fopen("/logfiles/pickitems.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}

stock LogBizCoOwner(string[])
{
	new
	    entry[256],
		month,
	...
	format(entry, sizeof(entry), "\n[%02d/%02d/%d] %s", day, month, year, string);
	new File:hFile;
	hFile = fopen("/logfiles/biz_coowner.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}

stock LogGunrack(string[])
{
	new
	    entry[256],
		month,
	...
	format(entry, sizeof(entry), "\n[%02d/%02d/%d] %s", day, month, year, string);
	new File:hFile;
	hFile = fopen("/logfiles/gunrack.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}

stock LogDropItem(string[])
{
	new
	    entry[256],
		month,
	...
	format(entry, sizeof(entry), "\n[%02d/%02d/%d] %s", day, month, year, string);
	new File:hFile;
	hFile = fopen("/logfiles/dropitems.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}
stock LogASellHouse(string[])
{
	new
	    entry[256],
		month,
	...
	format(entry, sizeof(entry), "\n[%02d/%02d/%d] %s", day, month, year, string);
	new File:hFile;
	hFile = fopen("/logfiles/a_sellhouse.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}
stock LogASellBiznis(string[])
{
	new
	    entry[256],
		month,
	...
	format(entry, sizeof(entry), "\n[%02d/%02d/%d] %s", day, month, year, string);
	new File:hFile;
	hFile = fopen("/logfiles/a_sellbiz.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}
stock LogASellComplex(string[])
{
	new
	    entry[256],
		month,
	...
	format(entry, sizeof(entry), "\n[%02d/%02d/%d] %s", day, month, year, string);
	new File:hFile;
	hFile = fopen("/logfiles/a_sellcomplex.txt", io_append);
	fwrite(hFile, entry);
	fclose(hFile);
}
