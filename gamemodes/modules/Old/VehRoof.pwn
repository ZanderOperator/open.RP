...
/*stock Float:VehRoofPos(vehicleid, poscoo)
{
	new VehRoofModel = GetVehicleModel(vehicleid);
	new Float:VehRoofCoo[3];
	if(VehRoofModel == 536)
	{
	    VehRoofCoo[0] = 0.000000;
	    VehRoofCoo[1] = 0.000000;
	    VehRoofCoo[2] = 0.000000;
	}
	else if(VehRoofModel == 567)
	{
	    VehRoofCoo[0] = 0.000000;
	    VehRoofCoo[1] = 0.300000;
	    VehRoofCoo[2] = -0.240000;
	}
	return VehRoofCoo[poscoo];
}*/
